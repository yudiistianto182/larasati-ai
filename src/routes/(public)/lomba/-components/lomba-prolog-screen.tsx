...
export function LombaPrologScreen({ onProceed }: LombaPrologScreenProps) {
  ...
  return (
    <div className="relative z-20 min-h-screen w-full flex flex-col items-center justify-center p-4 sm:p-6 lg:p-10 select-none overflow-x-hidden">
      ...
      {/* Atmospheric Ambient Spotlight Highlights */}
